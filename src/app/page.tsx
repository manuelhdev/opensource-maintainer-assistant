...
import { useGitHubActivity, type GitHubActivity, type GitHubActivityItem } from "@/hooks/useGitHubActivity";
    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 xl:grid-cols-2">
        <ActivityList
          ...
          totalCount={activity?.openIssues ?? 0}
          loading={activityLoading}
        ...
        <ActivityList
          ...
          totalCount={activity?.openPullRequests ?? 0}
          loading={activityLoading}
                ...
                <div className="flex items-start justify-between gap-4">
                  <div>
                    ...
                    <p className="mt-1 text-xs text-slate-500">
                      #{item.number} opened by {item.author}
                    </p>
                  </div>
